...
If(ROOT_CONFIG_EXECUTABLE)
  ...
  MESSAGE(STATUS "Looking for ROOT... - Found version is ${ROOT_VERSION_STRING} at ${ROOT_INSTALL_DIR}/bin/root")   
  ...
  string(REPLACE "." ";" VERSION_LIST ${ROOT_VERSION_STRING})
  list(GET VERSION_LIST 0 ROOT_VERSION_MAJOR)
  list(GET VERSION_LIST 1 ROOT_VERSION_MINOR)
  list(GET VERSION_LIST 2 ROOT_VERSION_PATCH)
